...
if __name__ == '__main__':
    ...
    adjective=simpledialog.askstring(title="Adjective", prompt="Think of an adjective")
    # Get the player to enter a type of liquid
    liquid=simpledialog.askstring(title="Liquid", prompt="Enter a type of liquid")
    # Get the player to enter a body part
    bodypart=simpledialog.askstring(title="body part", prompt="Give us a body part")
    # Get the player to enter a verb
    verb=simpledialog.askstring(title="verb", prompt="think of a verb")
    # Get the player to enter a place
    place=simpledialog.askstring(title="place", prompt="Enter the name of a place")
